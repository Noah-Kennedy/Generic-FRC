...
import com.nicoletfear.Stronghold2016.commands.OpenLoopArm;
...
public class Arm extends Subsystem {
    ...
    public void openLoopArmControl(double input){
    	positionMotor.changeControlMode(TalonControlMode.PercentVbus);
    	double output = RobotMap.armSpeedScaling * input;
    	positionMotor.set(output);
    }
    //moves arm up
    public void armDown(){
